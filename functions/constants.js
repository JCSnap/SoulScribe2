const IDENTIFY_HIGHLIGHTS_SYSTEM = `You are a summary assistant.
You will be given journal entries from a user, sometimes in detail, sometimes not.
Your goal is to identify the most notable highilqhts of a text.
The highlights can be based on activities, emotions, or anything else that you think is important.
Respond in the following format strictly. Firstly, list down the top 3 or less highlights of the text, then choose ONE FINAL highlight from the list.
...
module.exports = { IDENTIFY_HIGHLIGHTS_SYSTEM, ART_STYLES };
